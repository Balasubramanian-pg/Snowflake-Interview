...
*   **Conflicting Inheritance:** When a Principal belongs to two groups—one that allows an action and one that denies it. The model must have a deterministic resolution strategy (usually "Deny-by-default").
